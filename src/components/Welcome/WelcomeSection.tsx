...
export const WelcomeSection: React.FC = () => {
  ...
  return (
    <section className="relative py-16 lg:py-24 bg-slate-50 text-slate-900 overflow-hidden border-t border-slate-200">
      {/* Soft warm ambient background glow */}
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-amber-100/60 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-blue-50/80 rounded-full blur-3xl pointer-events-none" />

      <div className="max-w-[1360px] mx-auto px-6 md:px-10 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          {/* Left Column: Authentic Hospitality Welcome Message */}
          <div className="lg:col-span-7 space-y-6">
            ...
            {/* Main Title */}
            <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl font-semibold leading-tight text-slate-900 tracking-tight">
              {welcomeContent?.title || 'Where Alpine Serenity Meets Waterfront Luxury'}
            </h2>

            {/* Verified Body Text */}
            <p className="text-slate-600 font-sans text-base sm:text-lg leading-relaxed font-light">
            ...
            <div className="border-l-4 border-amber-500 bg-amber-500/10 p-5 rounded-r-2xl shadow-sm space-y-1">
              ...
              <div className="text-xs font-bold text-amber-700 tracking-wider uppercase pt-1">
                — ORA Lake View Team
              </div>
            </div>
            ...
            <div className="pt-2">
              <Link
                to="/rooms"
                className="inline-flex items-center justify-center px-8 py-3.5 text-xs sm:text-sm font-sans font-bold tracking-widest text-white uppercase transition-all duration-300 rounded-full bg-slate-900 hover:bg-amber-500 hover:text-slate-950 shadow-xl hover:shadow-amber-500/30 hover:scale-105 active:scale-95"
              >
          ...
          <div className="lg:col-span-5 relative mt-6 lg:mt-0">
            {/* Verified Floating Transit Badge (170m / 2 mins walk to Niederried Train Station) */}
            <div className="absolute -top-4 right-4 sm:right-6 z-30 bg-slate-900 text-white font-bold px-4 py-2.5 rounded-2xl shadow-xl border border-white/20 flex items-center space-x-3 backdrop-blur-md">
            ...
            <div className="relative rounded-3xl overflow-hidden border border-slate-200 shadow-2xl group bg-white">
              ...
              <div className="absolute bottom-5 left-5 right-5 p-4 rounded-2xl bg-white/90 backdrop-blur-md border border-slate-200 flex items-center justify-between shadow-lg">
                <div>

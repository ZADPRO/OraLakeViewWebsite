...
export const Header: React.FC = () => {
  ...
  return (
    <>
      <header
        className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${scrolled ? 'py-3 bg-slate-950/70 backdrop-blur-md shadow-2xl' : 'py-5'
          }`}
      >
        <div className="max-w-[1440px] mx-auto px-6 md:px-10 flex items-center justify-between relative">
          ...
          <nav className="hidden lg:flex items-center justify-center bg-white/10 backdrop-blur-xl border border-white/20 rounded-full px-8 py-2.5 shadow-2xl space-x-8 absolute left-1/2 -translate-x-1/2">
            <Link
              to="/"
              className={`font-sans text-[15px] font-medium tracking-wide transition-colors duration-200 ${isActive('/') ? 'text-amber-400 font-semibold' : 'text-white/90 hover:text-white'
                }`}
            >
            ...
            <Link
              to="/about-us"
              className={`font-sans text-[15px] font-medium tracking-wide transition-colors duration-200 ${isActive('/about-us')
            ...
            <Link
              to="/rooms"
              className={`font-sans text-[15px] font-medium tracking-wide transition-colors duration-200 ${isActive('/rooms')
                  ? 'text-amber-400 font-semibold'
                  : 'text-white/90 hover:text-white'
                }`}
            >
            ...
            <Link
              to="/gallery"
              className={`font-sans text-[15px] font-medium tracking-wide transition-colors duration-200 ${isActive('/gallery')
                  ? 'text-amber-400 font-semibold'
                  : 'text-white/90 hover:text-white'
                }`}
            >
            ...
            <Link
              to="/contact-us"
              className={`font-sans text-[15px] font-medium tracking-wide transition-colors duration-200 ${isActive('/contact-us')
                  ? 'text-amber-400 font-semibold'
                  : 'text-white/90 hover:text-white'
                }`}
            >
          ...
          <div className="hidden lg:flex items-center space-x-3 z-50">
            ...
            >
              ...
              <div
                className={`absolute top-1 bottom-1 w-7 h-7 rounded-full transition-all duration-300 shadow-md ${season === 'summer'
              ...
              {/* Sun Icon (Summer) */}
              <span
                className={`relative z-10 w-7 h-7 flex items-center justify-center text-sm transition-all duration-200 ${season === 'summer' ? 'opacity-100 scale-110' : 'opacity-50 group-hover:opacity-80'
                  }`}
              >
              ...
              <span
                className={`relative z-10 w-7 h-7 flex items-center justify-center text-sm transition-all duration-200 ${season === 'winter' ? 'opacity-100 scale-110' : 'opacity-50 group-hover:opacity-80'
                  }`}
              >
                ...
                <div className="absolute right-0 mt-2 w-36 rounded-2xl bg-slate-900/95 border border-white/15 shadow-2xl py-2 backdrop-blur-xl z-50 animate-fade-in">
                  {LANGUAGES.map((lang) => (
                    <button
                      ...
                      className={`w-full flex items-center justify-between px-4 py-2.5 text-xs font-semibold tracking-wider transition-colors ${language === lang.code
          ...
          <div className="lg:hidden flex items-center space-x-2 sm:space-x-3 z-50">
            ...
            >
              {/* Sliding Active Pill Background Indicator */}
              <div
                className={`absolute top-1 bottom-1 w-6 h-6 rounded-full transition-all duration-300 shadow-md ${season === 'summer'
                    ? 'left-1 bg-gradient-to-r from-amber-500 to-amber-600'
              ...
              {/* Sun Icon (Summer) */}
              <span
                className={`relative z-10 w-6 h-6 flex items-center justify-center text-xs transition-all duration-200 ${season === 'summer' ? 'opacity-100 scale-110' : 'opacity-50 group-hover:opacity-80'
                  }`}
              >
              ...
              {/* Snowflake Icon (Winter) */}
              <span
                className={`relative z-10 w-6 h-6 flex items-center justify-center text-xs transition-all duration-200 ${season === 'winter' ? 'opacity-100 scale-110' : 'opacity-50 group-hover:opacity-80'
                  }`}
              >
      ...
      <div
        className={`fixed inset-0 w-full h-full bg-[#0E1015] z-50 lg:hidden flex flex-col justify-between p-8 md:p-12 transition-all duration-500 ${mobileMenuOpen
        ...
        <div className="my-auto py-8 space-y-6 md:space-y-8">
          <nav className="flex flex-col space-y-5 md:space-y-7">
            <Link
              to="/"
              onClick={() => setMobileMenuOpen(false)}
              className={`font-serif text-3xl md:text-5xl font-bold tracking-widest uppercase transition-all duration-300 block ${isActive('/')
            ...
            <Link
              to="/about-us"
              onClick={() => setMobileMenuOpen(false)}
              className={`font-serif text-3xl md:text-5xl font-bold tracking-widest uppercase transition-all duration-300 block ${isActive('/about-us')
                  ? 'text-amber-400 scale-105 origin-left'
                  : 'text-white/90 hover:text-amber-300'
                }`}
            >
            ...
            <Link
              to="/rooms"
              onClick={() => setMobileMenuOpen(false)}
              className={`font-serif text-3xl md:text-5xl font-bold tracking-widest uppercase transition-all duration-300 block ${isActive('/rooms')
                  ? 'text-amber-400 scale-105 origin-left'
                  : 'text-white/90 hover:text-amber-300'
                }`}
            >
            ...
            <Link
              to="/gallery"
              onClick={() => setMobileMenuOpen(false)}
              className={`font-serif text-3xl md:text-5xl font-bold tracking-widest uppercase transition-all duration-300 block ${isActive('/gallery')
                  ? 'text-amber-400 scale-105 origin-left'
                  : 'text-white/90 hover:text-amber-300'
                }`}
            >
            ...
            <Link
              to="/contact-us"
              onClick={() => setMobileMenuOpen(false)}
              className={`font-serif text-3xl md:text-5xl font-bold tracking-widest uppercase transition-all duration-300 block ${isActive('/contact-us')
                  ? 'text-amber-400 scale-105 origin-left'
                  : 'text-white/90 hover:text-amber-300'
                }`}
            >
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex bg-white/10 p-1 rounded-full border border-white/20">
              <button
                ...
                className={`px-3 py-1 rounded-full text-xs font-extrabold tracking-wider transition-all flex items-center space-x-1.5 ${season === 'summer'
              ...
              <button
                ...
                className={`px-3 py-1 rounded-full text-xs font-extrabold tracking-wider transition-all flex items-center space-x-1.5 ${season === 'winter'
            ...
            <div className="flex space-x-2">
              {LANGUAGES.map((lang) => (
                <button
                  ...
                  className={`px-3 py-1.5 rounded-lg text-xs font-bold tracking-wider transition-all ${language === lang.code

...
export const PrivacyPolicyTerms: React.FC = () => {
  ...
  const policyContent = getContent('policies');
        ...
        <div className="max-w-5xl mx-auto px-6 text-center space-y-4">
          <div className="inline-flex items-center space-x-3 bg-amber-500/10 border border-amber-500/30 px-4 py-1.5 rounded-full">
            ...
            <span className="text-[#C68D53] text-xs font-bold uppercase tracking-widest">
              {policyContent?.badge || 'GUEST INFORMATION & POLICIES'}
            </span>
          </div>

          <h1 className="font-serif text-4xl md:text-6xl font-bold tracking-tight text-white">
            {policyContent?.title || 'Privacy Policy & Terms'}
          </h1>
      ...
      <div className="max-w-5xl mx-auto px-6 py-12 md:py-16 space-y-12 flex-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-slate-900/60 border border-slate-800 rounded-3xl p-8 shadow-xl space-y-4 hover:border-amber-500/40 transition-colors">
            ...
            <h2 className="font-serif text-2xl font-bold text-white tracking-tight">
              {policyContent?.privacyTitle || 'Privacy Policy'}
            </h2>
            <p className="text-slate-300 text-sm leading-relaxed font-sans">
              {policyContent?.privacyDesc ||
          ...
          <div className="bg-slate-900/60 border border-slate-800 rounded-3xl p-8 shadow-xl space-y-4 hover:border-amber-500/40 transition-colors">
            ...
            <h2 className="font-serif text-2xl font-bold text-white tracking-tight">
              {policyContent?.termsTitle || 'Terms & Conditions'}
            </h2>
            <p className="text-slate-300 text-sm leading-relaxed font-sans">
              {policyContent?.termsDesc ||
        ...
        <div className="space-y-6">
          <div className="flex items-center space-x-3">
            ...
            <h3 className="font-serif text-2xl font-semibold text-white tracking-wide uppercase">
              {policyContent?.guidelinesTitle || 'Hotel Guidelines & Amenities Policies'}
            </h3>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-slate-900/40 border border-slate-800/80 rounded-2xl p-6 space-y-3">
              <div className="flex items-center space-x-3 text-[#C68D53]">
                ...
                <h4 className="font-bold text-sm text-white uppercase tracking-wider">
                  {policyContent?.childTitle || 'Child Policies'}
                </h4>
              </div>
              <ul className="space-y-2 text-xs text-slate-300 font-sans leading-relaxed">
                <li className="flex items-start space-x-2">
                  <span className="text-[#C68D53] font-bold">•</span>
                  <span>{policyContent?.child1 || 'Children 5 and under can stay for free.'}</span>
                </li>
                <li className="flex items-start space-x-2">
                  <span className="text-[#C68D53] font-bold">•</span>
                  <span>{policyContent?.child2 || 'Children from 6 to 10 years old can stay for CHF 50.00 per child per night.'}</span>
                </li>
                <li className="flex items-start space-x-2">
                  <span className="text-[#C68D53] font-bold">•</span>
                  <span>{policyContent?.child3 || 'Children from 11 to 17 years old can stay for CHF 75.00 per child per night.'}</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-slate-900/40 border border-slate-800/80 rounded-2xl p-6 space-y-3">
              <div className="flex items-center space-x-3 text-[#C68D53]">
                ...
                <h4 className="font-bold text-sm text-white uppercase tracking-wider">
                  {policyContent?.internetParkingTitle || 'Internet & Parking'}
                </h4>
              </div>
              <ul className="space-y-2 text-xs text-slate-300 font-sans leading-relaxed">
                <li className="flex items-start space-x-2">
                  <span className="text-[#C68D53] font-bold">•</span>
                  <span>{policyContent?.internet || 'WiFi is available in all areas and is free of charge.'}</span>
                </li>
                <li className="flex items-start space-x-2">
                  <span className="text-[#C68D53] font-bold">•</span>
                  <span>{policyContent?.parking || 'Free private parking info is available on our facilities & services section.'}</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-slate-900/40 border border-slate-800/80 rounded-2xl p-6 space-y-3">
              <div className="flex items-center space-x-3 text-[#C68D53]">
                ...
                <h4 className="font-bold text-sm text-white uppercase tracking-wider">
                  {policyContent?.petsTitle || 'Pets Allowed'}
                </h4>
              </div>
              <ul className="space-y-2 text-xs text-slate-300 font-sans leading-relaxed">
                <li className="flex items-start space-x-2">
                  <span className="text-[#C68D53] font-bold">•</span>
                  <span>{policyContent?.petsDesc || 'Pets are welcome at ORA Lake View with no extra charges.'}</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-slate-900/40 border border-slate-800/80 rounded-2xl p-6 space-y-3">
              <div className="flex items-center space-x-3 text-[#C68D53]">
                ...
                <h4 className="font-bold text-sm text-white uppercase tracking-wider">
                  {policyContent?.checkInOutTitle || 'Check-in & Check-out'}
                </h4>
              </div>
              <ul className="space-y-2 text-xs text-slate-300 font-sans leading-relaxed">
                <li className="flex items-start space-x-2">
                  <span className="text-[#C68D53] font-bold">•</span>
                  <span>{policyContent?.checkIn || 'Check-in: 2:00 PM to 10:00 PM'}</span>
                </li>
                <li className="flex items-start space-x-2">
                  <span className="text-[#C68D53] font-bold">•</span>
                  <span>{policyContent?.checkOut || 'Check-out: Until 11:00 AM'}</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-slate-900/40 border border-slate-800/80 rounded-2xl p-6 space-y-3">
              <div className="flex items-center space-x-3 text-[#C68D53]">
                ...
                <h4 className="font-bold text-sm text-white uppercase tracking-wider">
                  {policyContent?.requirementsTitle || 'Guest Requirements'}
                </h4>
              </div>
              <ul className="space-y-2 text-xs text-slate-300 font-sans leading-relaxed">
                <li className="flex items-start space-x-2">
                  <span className="text-[#C68D53] font-bold">•</span>
                  <span>{policyContent?.reqAddress || 'Address: Guests do not have to provide address details upon booking.'}</span>
                </li>
                <li className="flex items-start space-x-2">
                  <span className="text-[#C68D53] font-bold">•</span>
                  <span>{policyContent?.reqPhone || 'Phone Number: Guests must provide a valid phone number when booking.'}</span>
                </li>
                <li className="flex items-start space-x-2">
                  <span className="text-[#C68D53] font-bold">•</span>
                  <span>{policyContent?.reqAge || 'Age Limit / Curfew: No age limit, no curfew.'}</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-slate-900/40 border border-slate-800/80 rounded-2xl p-6 space-y-3">
              <div className="flex items-center space-x-3 text-[#C68D53]">
                ...
                <h4 className="font-bold text-sm text-white uppercase tracking-wider">
                  {policyContent?.staysDamageTitle || 'Stays & Damage Policy'}
                </h4>
              </div>
              <ul className="space-y-2 text-xs text-slate-300 font-sans leading-relaxed">
                <li className="flex items-start space-x-2">
                  <span className="text-[#C68D53] font-bold">•</span>
                  <span>{policyContent?.longStays || '30+ Night Stays: Stays longer than 30 nights are accepted up to 90 nights.'}</span>
                </li>
                <li className="flex items-start space-x-2">
                  <span className="text-[#C68D53] font-bold">•</span>
                  <span>{policyContent?.groupStays || 'Group Stays: Policy exceptions apply for group reservations exceeding 4 rooms.'}</span>
                </li>
                <li className="flex items-start space-x-2">
                  <span className="text-[#C68D53] font-bold">•</span>
                  <span>{policyContent?.damageDeposit || 'Damage Deposit: Guests are not required to pay a damage deposit.'}</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="bg-gradient-to-r from-amber-950/40 via-slate-900 to-amber-950/40 border border-amber-500/30 rounded-3xl p-8 md:p-12 text-center space-y-4 relative overflow-hidden shadow-2xl">
          ...
          <p className="font-serif italic text-xl md:text-3xl text-amber-100 max-w-3xl mx-auto leading-relaxed">
            {policyContent?.quote || '“The lake and the mountains have become my landscape, my real world.”'}
          </p>
          <p className="text-xs uppercase tracking-[0.3em] font-bold text-[#C68D53]">
            {policyContent?.author || '— GEORGES SIMENON'}
          </p>
        </div>
      </div>
